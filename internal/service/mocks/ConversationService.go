...
// ConversationService is an autogenerated mock type for the ConversationService type
type ConversationService struct {
	mock.Mock
}

// CreateConversation provides a mock function with given fields: participants
func (_m *ConversationService) CreateConversation(participants []int) (domain.ConversationResponse, error) {
...
func (_m *ConversationService) GetConversationByID(id int) (domain.ConversationResponse, error) {
	ret := _m.Called(id)
...
// NewConversationService creates a new instance of ConversationService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewConversationService(t interface {
	mock.TestingT
	Cleanup(func())
}) *ConversationService {
